...
// 文字化け対策にSJISへエンコード
	...
	$csv_data_file_name = mb_convert_encoding($file_name, "SJIS", "UTF-8");
	$log_ln[3] = str_replace ( ",", "，", $csv_data_file_name);	
...
// ファイルダウンロード
$file =strval("csv/log_download.csv");
